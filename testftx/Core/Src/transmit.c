...
//static uint8 tx_msg[] = {0xC5, 0, 'H','Y', 'D', 'E', 'R', 'A', 'B', 'A','D', 0, 0};
static uint8 tx_msg[15] = "T0Hyderabad\r\n";
...
//    lcd_display_str(APP_NAME);
    ...
    while(1)
    {
        ...
        dwt_writetxfctrl(sizeof(tx_msg), 2, 0); /* Zero offset in TX buffer, no ranging. */
